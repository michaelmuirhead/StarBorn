...
export default function BuildMenu() {
  ...
  return (
    <section className="panel p-2.5 flex flex-col gap-1.5 flex-1 min-h-0 overflow-hidden">
      <div className="flex items-baseline justify-between shrink-0">
        <h2 className="text-[11px] uppercase tracking-widest text-mars-200">Tile</h2>
      </div>
      <div className="shrink-0">
        <TileInspector />
      </div>
      <h2 className="text-[11px] uppercase tracking-widest text-mars-200 pt-1 shrink-0">
        Construction
      </h2>
