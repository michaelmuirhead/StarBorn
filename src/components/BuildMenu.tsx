...
export default function BuildMenu() {
  ...
  return (
    <section className="panel p-3 flex flex-col gap-2 flex-1 min-h-0 overflow-hidden">
      <h2 className="text-sm uppercase tracking-widest text-mars-200 shrink-0">Tile</h2>
      <div className="shrink-0">
        <TileInspector />
      </div>
      <h2 className="text-sm uppercase tracking-widest text-mars-200 pt-1 shrink-0">
        Construction
      </h2>
      <p className="text-[11px] text-space-200 -mt-1 shrink-0">
